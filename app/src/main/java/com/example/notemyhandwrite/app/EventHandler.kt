...
import com.example.notemyhandwrite.uiapp.IScreenManagement
import com.example.notemyhandwrite.uiapp.ScreenManagement
import java.io.File
import java.io.IOException

object EventHandler : IHandler {

    private val screenManagement: IScreenManagement = ScreenManagement
    ...
    override fun activityResultHandler(requestCode: Int, resultCode: Int, data: Intent?) {
        if (requestCode == IMAGE_CAMERA && resultCode == Activity.RESULT_OK) {
            screenManagement.setImageInChooseInputScreen(imageUri!!)
        }
