...
import com.example.notemyhandwrite.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val handler : IHandler = EventHandler
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        handler.activityResultHandler(requestCode,resultCode,data)
    }
}